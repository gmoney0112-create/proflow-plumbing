...
export const CallToAction: React.FC<{ localFrame: number }> = ({ localFrame }) => {
  ...
  // Pulse animation for the phone number
    ...
    >
      ...
      {[ring1, ring2].map((r, i) => (
        <div
          ...
          style={{
            ...
            left: "50%",
            top: "50%",
            width: interpolate(r, [0, 1], [200, 1400]),
            height: interpolate(r, [0, 1], [200, 1400]),
            borderRadius: "50%",
            border: "2px solid rgba(0,149,255,0.15)",
            transform: "translate(-50%, -50%)",
            opacity: interpolate(r, [0, 0.5, 1], [0.8, 0.4, 0]),
          }}
        />
      ))}
      ...
      <div
        style={{
          ...
          borderRadius: 4,
          marginBottom: 30,
          opacity: interpolate(localFrame, [5, 20], [0, 1], { extrapolateRight: "clamp" }),
      ...
      <div style={{ textAlign: "center", marginBottom: 50 }}>
        <AnimatedText
          ...
          style={{
            ...
            color: "#ffffff",
            lineHeight: 1,
            textShadow: "0 0 40px rgba(0,149,255,0.4)",
      ...
      <div
        style={{
          ...
          marginBottom: 50,
          opacity: interpolate(localFrame, [40, 60], [0, 1], { extrapolateRight: "clamp" }),
        }}
      >
        <div
          style={{
            ...
            fontFamily: "'Arial Black', sans-serif",
            color: "#0095ff",
            textShadow: "0 0 40px rgba(0,149,255,0.7)",
            letterSpacing: 2,
          }}
        >
          📞 (555) PRO-FLOW
      ...
      <div
        style={{
          ...
          letterSpacing: 2,
          textTransform: "uppercase",
          boxShadow: "0 0 40px rgba(0,149,255,0.6), 0 8px 32px rgba(0,0,0,0.4)",
        }}
      >
      ...
      <div
        style={{
          ...
          gap: 40,
          marginTop: 50,
          opacity: interpolate(localFrame, [80, 100], [0, 1], { extrapolateRight: "clamp" }),
        }}
      >
        {["Licensed & Insured", "5-Star Rated", "Same-Day Service"].map((badge) => (
          <div
            key={badge}
            style={{
