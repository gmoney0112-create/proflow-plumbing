  ...
  return (
    <div style={{ width, height, background: `radial-gradient(ellipse at 50% 50%, #0a1628 0%, #060d1a 60%, #020609 100%)`, position: "relative", overflow: "hidden", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", opacity: bgOpacity }}>
      ...
      <div style={{ transform: `scale(${logoScale})`, opacity: logoOpacity, textAlign: "center", zIndex: 10 }}>
        ...
        <div style={{ fontSize: 80, fontWeight: 900, fontFamily: "'Arial Black', sans-serif", color: "#ffffff", letterSpacing: -2, textShadow: "0 0 40px rgba(0,149,255,0.6)" }}>
      ...
      <div style={{ width: lineWidth, height: 3, background: "linear-gradient(90deg, transparent, #0095ff, #00d4ff, transparent)", borderRadius: 2, marginTop: 30, boxShadow: "0 0 15px #0095ff", zIndex: 10 }} />
