...
const CountUp: React.FC<{ target: number; localFrame: number; suffix: string }> = ({
  target,
  localFrame,
  suffix,
}) => {
  const eased = interpolate(localFrame, [0, 60], [0, 1], {
    ...
    >
      ...
      <div
        style={{
          ...
          right: 0,
          bottom: 0,
          background: "linear-gradient(45deg, transparent 40%, rgba(0,149,255,0.05) 50%, transparent 60%)",
        }}
      />
        ...
        {STATS.map((stat, i) => {
          ...
          return (
            <div
              key={i}
              style={{
                background: "linear-gradient(135deg, rgba(0,30,70,0.9), rgba(0,15,40,0.95))",
                ...
                opacity: cardOpacity,
                boxShadow: "0 8px 32px rgba(0,0,0,0.4), 0 0 0 1px rgba(0,149,255,0.1)",
              }}
            >
              ...
              <div
                style={{
                  ...
                  color: "#0095ff",
                  lineHeight: 1,
                  textShadow: "0 0 20px rgba(0,149,255,0.5)",
                }}
              >
